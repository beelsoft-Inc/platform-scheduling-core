...
namespace Tungnt\Admin\Scheduling;
...
class Scheduling extends Extension
{
    ...
    protected static function registerRoutes()
    {
        parent::routes(function ($router) {
            ...
            $router->get('scheduling', 'Tungnt\Admin\Scheduling\SchedulingController@index')->name('scheduling-index');
            $router->post('scheduling/run', 'Tungnt\Admin\Scheduling\SchedulingController@runEvent')->name('scheduling-run');
        });
    }
